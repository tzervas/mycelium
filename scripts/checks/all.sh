...
checks=(structured shell markdown links doc-currency schema grammar spell secrets format lint test myc-fmt myc-check myc-sec myc-lint myc-doc myc-spore proofs api deny)
failed=()
for c in "${checks[@]}"; do
