...
<ul>
  <li><a href="../corpus/pages/readme-4.html">Grammar artifacts README</a> &mdash; conformance corpus layout + checking</li>
...
<h3>Key grammar productions (from <code>mycelium.ebnf</code>)</h3>
...
<tr><td><code>matured</code></td><td>Header/manifest key for scope-level AOT promotion (never a fn modifier)</td><td>themed</td><td>RFC-0017; DN-02 §7</td></tr>
...
<ul>
  ...
  <li><a href="../corpus/pages/readme-5.html">stdlib spec index README</a> &mdash; module index, ring layering, cross-module reconciliation</li>
</ul>
...
Source ground truth: <code>docs/spec/grammar/mycelium.ebnf</code>, <code>.claude/memory/lang-lexicon-syntax.md</code>,
<code>docs/spec/stdlib/</code>, <code>crates/mycelium-l1/src/token.rs</code>. This page is an orientation aid (Empirical/Declared);
