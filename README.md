...
│   │   └── RFC-0005-Selection-Policy-Language.md          ← total cost-based policy + mandatory EXPLAIN
│   ├── adr/
...
| No implicit conversion; explicit `Swap` only | RFC-0001; ADR-? (FR-M3) | the central transparency rule |
