...
RFC-0001…0031, ADR-001…023, DN-01…27 — per-document status (Draft / Accepted / Enacted / Resolved) is
in [`docs/Doc-Index.md`](docs/Doc-Index.md); the newest (e.g. RFC-0025…0031) are still Draft. The Rust workspace has
