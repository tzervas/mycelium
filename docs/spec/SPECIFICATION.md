...
| 10.5 | Inspectable lowering — ✅ ≥2 dumpable/diffable stages (`mycelium-core::lower`: `core` → A-normal-form `substrate` with scheduled `PhysicalLayout`; SC-4/WF5, M-112). MLIR→LLVM skeleton + interp↔AOT differential still open | M-112 ([#17](https://github.com/tzervas/mycelium/issues/17)), M-150 ([#26](https://github.com/tzervas/mycelium/issues/26)), M-151 ([#27](https://github.com/tzervas/mycelium/issues/27)) | 1 |
