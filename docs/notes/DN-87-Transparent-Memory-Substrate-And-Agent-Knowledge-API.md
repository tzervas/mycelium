...
- **Run 1 (2026-07-07, PR #1254) — CLOSED (serving Layer-1).** Over the PR-#1254 **dev** codebook of
  5141 rows — *frozen, not re-run for a tier promotion; the promoted index (integration and main
  tiers alike) is 5119 rows (the isolated tree carries fewer corpus items)* — (seed
