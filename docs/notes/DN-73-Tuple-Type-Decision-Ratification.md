...
|---|---|
| **Note** | DN-73 |
| **Status** | **Recommended, pending orchestrator acceptance** (2026-07-02). The maintainer **delegated this decision to the orchestrator** (2026-07-02, in-session directive — `Declared`); this dossier prepares options and a recommendation. It does **not** self-ratify (house rule #3 / G2): the status flip to Accepted is the orchestrator's act, recorded append-only in the changelog below. |
