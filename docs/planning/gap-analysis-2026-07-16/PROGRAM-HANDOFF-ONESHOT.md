...
| 2026-07-16 | **L2A post-C3+C4 remeasure** (`167f0bf2`): Empirical default-5 **19.5%** / all-7 **22.2%**; C3 fs **38.3%** + phylum Δ_basis **+21.3pp** confirmed; C4 eval/rand Clean confirmed. Residuals: Import single-file, Source/Sink. See `M1006-remeasure-post-C3C4-2026-07-16.md` — **no one-shot claim** |
