...
| 0025 | Operator Syntax: Symbolic Infix Sugar & Precedence Table | **Draft** (2026-06-23; planning stub — decides nothing normatively; binding decision deferred; feeds E7-5 / E11-1) | RFC-0006 §3/§4.3; RFC-0007 §4.1–§4.8; RFC-0024 (word operators as first-class values); DN-23 (recommendation: hybrid word-kernel + optional symbol sugar, frontend-only desugaring, no L0/L1 change); E7-5 (M-705) |
