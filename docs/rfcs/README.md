...
| 0021 | Semantic-Level Projection Framework | **Accepted (framework)** (2026-06-18, maintainer ratification; framework + P1–P6 + registry normative; G11 gate discharged in `mycelium-lsp/src/project.rs`; LLM-leverage claim split to RP-1/M-381, not asserted) | RFC-0006 §3/§9 (L3, FR-S5); DN-09 §3.1; RFC-0001 §4.6/ADR-003; ADR-006; FR-C1/G11; RR-3 |
