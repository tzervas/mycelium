...
| 0032 | Kernel Self-Hosting Enablement Surface | **Draft** (2026-06-23; planning stub; the kernel prims + value representations that unblock E13-1 Tier-1/Tier-2 — a reduce-to-`Bool` comparison, binary arithmetic, sequence/string reprs, and the width-generics + core-1.0.0-placement questions are open; feeds E13-1, gated by E19-1/M-746) | RFC-0031 (§5 D4 — **Accepted**, names the blockers); RFC-0001 (value model); RFC-0007 (L1 kernel); ADR-022 (1.0.0 gate — core placement); KC-2/KC-3/G2/VR-5; `crates/mycelium-core/src/repr.rs` + `crates/mycelium-interp/src/prims.rs` (the gaps); E19-1 (M-746) |
