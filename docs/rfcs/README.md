...
`Draft → Accepted → Superseded`. RFC-0001…0005 are **Accepted** (solidified from the two research passes); RFC-0006 is a **Draft** (deliberation; concrete surface syntax gated on KC-2).
