...
| 0010 | Decode-Methodology Selection | **Accepted** | RFC-0005 (same selection mechanism, third site); RFC-0009 (§10.3 matrix + regime gate); RFC-0003; G2/G4/VR-5 |
...
| 0018 | Stage-1 Static Guarantee Grading | **Accepted** (2026-06-18, maintainer ratification; R18-Q1 = Design A; supersedes RFC-0007 §4.3; noninterference stays Declared-with-argument) | RFC-0007 §4.3/§4.4 (revision); RFC-0006 §8 Q3; RFC-0002 (Swap certificate = endorsement); LR-6; VR-5; T3.2 |
| 0019 | Traits & Parametric Polymorphism (LR-2) | **Accepted** (2026-06-18, maintainer ratification; coherence = orphan + global-uniqueness + reject-overlap; MPTC/assoc-types deferred to v2; coherence/S1 stay Declared-with-argument) | RFC-0007 §4.4 (the deferral); RFC-0006 LR-2/LR-5/LR-6; ADR-003; DN-03; KC-3; T3.3 |
