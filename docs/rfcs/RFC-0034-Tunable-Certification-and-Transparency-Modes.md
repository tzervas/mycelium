...
> **Clarifying footnote (append-only; captured 2026-07-18 from maintainer steer P3-Q2,
> `docs/planning/design-steer-2026-07-17/PROGRAM-HANDOFF-DESIGN-STEER-2026-07-17.md` §1.3).**
> First-fault records (the RFC-0013 `Diag` envelope extension, Amendment A1) **are** the
> inspectability-signal generation this section already mandates: "always generated from the middle
> tier up" therefore includes always-on first-fault record generation in `fast`. This is a
> clarification of existing normative text, not a new rule; consumption of those records stays
> dialable per the split above. Status of the capture: Draft until ratified.
...
| 2026-07-18 | *(unchanged — Enacted)* *(append-only clarifying footnote in §7, Draft)* | **P3-Q2 capture (course-correction A4):** added the §7 clarifying footnote recording the maintainer steer of 2026-07-17 — first-fault records (RFC-0013 Amendment A1 envelope) are the always-generated inspectability signal §7 already mandates in `fast`; a clarification of existing normative text, not an amendment to semantics. The footnote itself is **Draft until ratified**; the RFC's status is unchanged. Grounds: `docs/planning/design-steer-2026-07-17/PROGRAM-HANDOFF-DESIGN-STEER-2026-07-17.md` §1.3 P3-Q2, §4 item 4. |
