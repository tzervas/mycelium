...
|---|---|
| **RFC** | 0037 |
| **Status** | **Proposed** (2026-06-27) — the bracket kind-split, operator reallocation, return-arrow change, trit-literal reprefix, and layout-independence principle are normative **as proposed**; binding on maintainer ratification (Proposed → Accepted; house rule #3). Enacts no code. |
