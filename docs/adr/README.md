...
| 022 | Full-Language 1.0.0 Release-Readiness Gate: dual-version core⟂lang — kernel track T1 (preserves ADR-021 Gate A/B) + full-language program tracks T2–T9; 9 epics E10-1…E18-1; DN-25 program map | **Accepted** (2026-06-23; supersedes ADR-021; **T1 scope amended by ADR-024**) | `ADR-022-Full-Language-1.0.0-Release-Gate.md` |
