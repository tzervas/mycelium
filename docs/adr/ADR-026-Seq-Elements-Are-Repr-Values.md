...
> **Posture (VR-5).** Proposed decision direction. **One-way door** (admitting general algebraic
> elements later is additive; retracting them is not). No implementation lands with this ADR.
...
## Status
**Proposed (recommended).** **One-way door.**
