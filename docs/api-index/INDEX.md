...
| `mycelium_l1::CheckError` | struct | `crates/mycelium-l1/src/checkty.rs:96` | An explicit check failure (never a silent pass or a guess — S5/G2). |
...
| `mycelium_l1::Env` | struct | `crates/mycelium-l1/src/checkty.rs:177` | The checked program environment: registry + function table. |
...
| `mycelium_l1::Ty` | enum | `crates/mycelium-l1/src/checkty.rs:37` | A v0 (monomorphic) type. |
...
| `mycelium_l1::ast::Arm` | struct | `crates/mycelium-l1/src/ast.rs:390` | A `match` arm. |
| `mycelium_l1::ast::BaseType` | enum | `crates/mycelium-l1/src/ast.rs:220` | A base (un-annotated) type. |
| `mycelium_l1::ast::Ctor` | struct | `crates/mycelium-l1/src/ast.rs:129` | One constructor of a [`TypeDecl`]. |
| `mycelium_l1::ast::Expr` | enum | `crates/mycelium-l1/src/ast.rs:284` | An expression. |
| `mycelium_l1::ast::FnDecl` | struct | `crates/mycelium-l1/src/ast.rs:166` | A function definition. |
| `mycelium_l1::ast::FnSig` | struct | `crates/mycelium-l1/src/ast.rs:149` | A function signature (shared by trait requirements and `fn` definitions). |
| `mycelium_l1::ast::Item` | enum | `crates/mycelium-l1/src/ast.rs:64` | A top-level item. |
| `mycelium_l1::ast::Literal` | enum | `crates/mycelium-l1/src/ast.rs:431` | A literal value. |
...
| `mycelium_l1::ast::Param` | struct | `crates/mycelium-l1/src/ast.rs:177` | A value parameter `name: type`. |
| `mycelium_l1::ast::Path` | struct | `crates/mycelium-l1/src/ast.rs:6` | A dotted path (`signals.demo`, `core.binary`); also a bare name. |
| `mycelium_l1::ast::Pattern` | enum | `crates/mycelium-l1/src/ast.rs:411` | A pattern. |
| `mycelium_l1::ast::Scalar` | enum | `crates/mycelium-l1/src/ast.rs:258` | A scalar element kind. |
| `mycelium_l1::ast::Sparsity` | enum | `crates/mycelium-l1/src/ast.rs:249` | Declared sparsity of a VSA type. |
| `mycelium_l1::ast::Strength` | enum | `crates/mycelium-l1/src/ast.rs:271` | A guarantee-lattice strength. |
| `mycelium_l1::ast::TraitDecl` | struct | `crates/mycelium-l1/src/ast.rs:138` | `trait Name<params> { fn … }` (LR-2; conventional term). |
| `mycelium_l1::ast::TypeDecl` | struct | `crates/mycelium-l1/src/ast.rs:118` | `type Name<params> = Ctor \| Ctor(field, …) \| …` (LR-1). |
| `mycelium_l1::ast::TypeRef` | struct | `crates/mycelium-l1/src/ast.rs:186` | A type with an optional guarantee-strength index (`T @ Exact`; LR-6). |
| `mycelium_l1::check_and_resolve` | fn | `crates/mycelium-l1/src/checkty.rs:738` | Like [`check_nodule`], but also returns the **fully-resolved longhand twin** of the program |
| `mycelium_l1::check_nodule` | fn | `crates/mycelium-l1/src/checkty.rs:694` | Check a whole nodule: build the registry (prelude + declarations), then type every function |
| `mycelium_l1::check_nodule_matured` | fn | `crates/mycelium-l1/src/checkty.rs:703` | Like [`check_nodule`] but with an explicit `matured_scope` flag (RFC-0017 §4.2): when `true`, |
| `mycelium_l1::checkty` | mod | `crates/mycelium-l1/src/lib.rs:31` | — |
| `mycelium_l1::checkty::CheckError` | struct | `crates/mycelium-l1/src/checkty.rs:96` | An explicit check failure (never a silent pass or a guess — S5/G2). |
| `mycelium_l1::checkty::CtorInfo` | struct | `crates/mycelium-l1/src/checkty.rs:151` | One constructor of a registered data type. |
| `mycelium_l1::checkty::DataInfo` | struct | `crates/mycelium-l1/src/checkty.rs:160` | A registered (monomorphic) data type. |
| `mycelium_l1::checkty::Env` | struct | `crates/mycelium-l1/src/checkty.rs:177` | The checked program environment: registry + function table. |
| `mycelium_l1::checkty::Env::ctor` | fn | `crates/mycelium-l1/src/checkty.rs:200` | Find the data type owning constructor `ctor`, with its index — `None` if no type has it. |
| `mycelium_l1::checkty::Env::ctor` | fn | `crates/mycelium-l1/src/checkty.rs:200` | Find the data type owning constructor `ctor`, with its index — `None` if no type has it. |
| `mycelium_l1::checkty::Ty` | enum | `crates/mycelium-l1/src/checkty.rs:37` | A v0 (monomorphic) type. |
| `mycelium_l1::checkty::check_and_resolve` | fn | `crates/mycelium-l1/src/checkty.rs:738` | Like [`check_nodule`], but also returns the **fully-resolved longhand twin** of the program |
| `mycelium_l1::checkty::check_nodule` | fn | `crates/mycelium-l1/src/checkty.rs:694` | Check a whole nodule: build the registry (prelude + declarations), then type every function |
| `mycelium_l1::checkty::check_nodule_matured` | fn | `crates/mycelium-l1/src/checkty.rs:703` | Like [`check_nodule`] but with an explicit `matured_scope` flag (RFC-0017 §4.2): when `true`, |
| `mycelium_l1::checkty::prim_kernel_name` | fn | `crates/mycelium-l1/src/checkty.rs:2662` | The surface→kernel prim-name mapping (the `Op` node's `prim` — RFC-0007 §4.1). |
| `mycelium_l1::checkty::prim_sig` | fn | `crates/mycelium-l1/src/checkty.rs:2648` | The builtin prim signature table `Π` (RFC-0007 §4.4 T-Op), width-polymorphic. |
...
| `mycelium_l1::token::ScalarTok` | enum | `crates/mycelium-l1/src/token.rs:181` | Scalar-kind keyword payload. |
| `mycelium_l1::token::Spanned` | struct | `crates/mycelium-l1/src/token.rs:207` | A token with its starting position. |
| `mycelium_l1::token::StrengthTok` | enum | `crates/mycelium-l1/src/token.rs:194` | Guarantee-strength keyword payload. |
| `mycelium_l1::token::Tok` | enum | `crates/mycelium-l1/src/token.rs:22` | A lexical token. |
| `mycelium_l1::token::keyword` | fn | `crates/mycelium-l1/src/token.rs:216` | Resolve an identifier-shaped lexeme to its keyword token, or `None` if it is a plain identifier. |
...
| `mycelium_mlir::bitnet::BitnetDotKernel` | struct | `crates/mycelium-mlir/src/bitnet.rs:274` | A compiled, in-process BitNet dot kernel: the `.so` (in a per-artifact temp dir, cleaned on drop), |
| `mycelium_mlir::bitnet::BitnetDotKernel::call` | fn | `crates/mycelium-mlir/src/bitnet.rs:323` | Run the kernel over `packed_weights` (packed under scheme) and |
| `mycelium_mlir::bitnet::BitnetDotKernel::call` | fn | `crates/mycelium-mlir/src/bitnet.rs:323` | Run the kernel over `packed_weights` (packed under scheme) and |
| `mycelium_mlir::bitnet::BitnetDotKernel::scheme` | fn | `crates/mycelium-mlir/src/bitnet.rs:68` | The packing scheme. |
| `mycelium_mlir::bitnet::BitnetDotKernel::scheme` | fn | `crates/mycelium-mlir/src/bitnet.rs:68` | The packing scheme. |
| `mycelium_mlir::bitnet::KERNEL_SCHEME:` | const | `crates/mycelium-mlir/src/bitnet.rs:124` | The packing this kernel decodes inline by default. |
| `mycelium_mlir::bitnet::compile_bitnet_dot` | fn | `crates/mycelium-mlir/src/bitnet.rs:360` | Compile the **I2_S** BitNet dot kernel to a shared object and load it in-process. |
| `mycelium_mlir::bitnet::compile_bitnet_dot_for` | fn | `crates/mycelium-mlir/src/bitnet.rs:367` | Compile the BitNet dot kernel for `scheme` to a shared object and load it in-process. |
| `mycelium_mlir::bitnet::emit_bitnet_dot_ir` | fn | `crates/mycelium-mlir/src/bitnet.rs:143` | Emit the textual LLVM IR for the **I2_S** packed-ternary dot kernel — the default scheme. |
| `mycelium_mlir::bitnet::emit_bitnet_dot_ir_for` | fn | `crates/mycelium-mlir/src/bitnet.rs:155` | Emit the textual LLVM IR for the packed-ternary dot kernel |
| `mycelium_mlir::bitnet::jit_ternary_dot` | fn | `crates/mycelium-mlir/src/bitnet.rs:403` | Convenience: pack `weights` under [`KERNEL_SCHEME`] (I2_S), compile the kernel, and run the dot |
| `mycelium_mlir::bitnet::jit_ternary_dot_for` | fn | `crates/mycelium-mlir/src/bitnet.rs:409` | As [`jit_ternary_dot`], but for an explicit `scheme` — packs `weights` under `scheme` and runs |
| `mycelium_mlir::bitnet::ternary_dot_ref` | fn | `crates/mycelium-mlir/src/bitnet.rs:131` | The reference (oracle) ternary dot product `Σ digit(wᵢ)·xᵢ` over `i64`, the exact semantics the |
...
| `mycelium_mlir::compile_bitnet_dot` | fn | `crates/mycelium-mlir/src/bitnet.rs:360` | Compile the **I2_S** BitNet dot kernel to a shared object and load it in-process. |
| `mycelium_mlir::compile_bitnet_dot_for` | fn | `crates/mycelium-mlir/src/bitnet.rs:367` | Compile the BitNet dot kernel for `scheme` to a shared object and load it in-process. |
...
| `mycelium_mlir::emit_bitnet_dot_ir` | fn | `crates/mycelium-mlir/src/bitnet.rs:143` | Emit the textual LLVM IR for the **I2_S** packed-ternary dot kernel — the default scheme. |
| `mycelium_mlir::emit_bitnet_dot_ir_for` | fn | `crates/mycelium-mlir/src/bitnet.rs:155` | Emit the textual LLVM IR for the packed-ternary dot kernel |
...
| `mycelium_mlir::jit_ternary_dot` | fn | `crates/mycelium-mlir/src/bitnet.rs:403` | Convenience: pack `weights` under [`KERNEL_SCHEME`] (I2_S), compile the kernel, and run the dot |
| `mycelium_mlir::jit_ternary_dot_for` | fn | `crates/mycelium-mlir/src/bitnet.rs:409` | As [`jit_ternary_dot`], but for an explicit `scheme` — packs `weights` under `scheme` and runs |
...
| `mycelium_mlir::ternary_dot_ref` | fn | `crates/mycelium-mlir/src/bitnet.rs:131` | The reference (oracle) ternary dot product `Σ digit(wᵢ)·xᵢ` over `i64`, the exact semantics the |
