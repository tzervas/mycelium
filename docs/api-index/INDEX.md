...
| `mycelium_l1::checkty::prim_kernel_name` | fn | `crates/mycelium-l1/src/checkty.rs:2676` | The surface→kernel prim-name mapping (the `Op` node's `prim` — RFC-0007 §4.1). |
| `mycelium_l1::checkty::prim_sig` | fn | `crates/mycelium-l1/src/checkty.rs:2662` | The builtin prim signature table `Π` (RFC-0007 §4.4 T-Op), width-polymorphic. |
