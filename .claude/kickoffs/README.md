...
| **`aot10`** | `aot10.md` | `crates/mycelium-mlir/**` · native-codegen scope | Sonnet · parallel-leaf | Status: **ready**; head `claude/head/aot10`; governs E15-1 (native AOT maturity, optimization & accel, T6); gate: ADR-022 T6 + DN-25; deps: E6-1 (native-path wave, M-725 subsumes remaining tasks) |
