...
> **UID:** `flp` · **Basis:** **ADR-038** (Proposed) §2.2/§2.4/§2.8 + the umbrella roadmap
...
| FLAG-V1 — the `lang 1.0.0` label reconciliation (resolvable at flip time) | — | M-945 close-out | ADR-038 §2.8 |
