...
;   is at most delta for a 'bundle_of_binds' composition.
;
...
;
; Run with:
;   z3 -smt2 20260629T164202Z-multihop-bundle_of_binds-A_exponential.smt2
;
...
; NOTE: No in-regime non-refuted points found for composition='bundle_of_binds'.
