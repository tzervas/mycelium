...
-- | M-832 / OQ-F — Multi-hop VSA capacity-refinement probe (nested_unbind, A_exponential).
--
...
--     For composition 'nested_unbind', model 'A_exponential':
--       m_eff(F, k, h) = F * k^h
...
module MultihopBound_nestedunbind_Aexponential where
