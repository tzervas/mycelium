//! `std.io` — std.io + serialize — single-consumption IO + canonical serialization.
//!
//! **Scaffold (Batch P5-B).** This crate is the registered, buildable skeleton for the
//! `std.io` standard-library module (M-514). The implementation lands in this
//! branch's wave per its design spec (`docs/spec/stdlib/io.md`) and the RFC-0016 §4.1
