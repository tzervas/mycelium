//! `std.math` — std.math — numeric functions over honest numerics.
//!
//! **Scaffold (Batch P5-B).** This crate is the registered, buildable skeleton for the
//! `std.math` standard-library module (M-525). The implementation lands in this
//! branch's wave per its design spec (`docs/spec/stdlib/math.md`) and the RFC-0016 §4.1
