//! `std.time` — std.time — clocks, durations, instants (monotonic vs wall).
//!
//! **Scaffold (Batch P5-B).** This crate is the registered, buildable skeleton for the
//! `std.time` standard-library module (M-529). The implementation lands in this
//! branch's wave per its design spec (`docs/spec/stdlib/time.md`) and the RFC-0016 §4.1
