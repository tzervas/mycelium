//! `std.testing` — std.testing — property / golden / differential harness.
//!
//! **Scaffold (Batch P5-B).** This crate is the registered, buildable skeleton for the
//! `std.testing` standard-library module (M-534). The implementation lands in this
//! branch's wave per its design spec (`docs/spec/stdlib/testing.md`) and the RFC-0016 §4.1
