...
//!
//! Layer 2 (the VSA semantic layer + its `Empirical`-gated eval, M-1018) lands additively on top of
//! this served product in a follow-on change; the fronts here serve Layer-1 only (`layer2_enabled`
//! is `false`), and nothing in this crate references Layer-2 until it lands.
