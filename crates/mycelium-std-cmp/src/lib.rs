//! `std.cmp` — std.cmp/convert — ordering, equality, non-representation conversion.
//!
//! **Scaffold (Batch P5-B).** This crate is the registered, buildable skeleton for the
//! `std.cmp` standard-library module (M-532). The implementation lands in this
//! branch's wave per its design spec (`docs/spec/stdlib/cmp.md`) and the RFC-0016 §4.1
